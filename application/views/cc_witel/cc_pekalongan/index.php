      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">CC Witel Pekalongan</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
      ...
      <div class="card card-danger">
        <div class="card-header py-3">
          <div class="d-sm-flex align-items-center justify-content-between">
            <h6 class="card-title">Data Fasteljab Witel Pekalongan</h6>
            <?php if($this->session->userdata('role')==='1' || $this->session->userdata('role')==='16') { ?>
            <a href="<?= base_url('Export/exportCcPekalongan'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Excel</a>
          <?php }?>
          </div>
        </div>
        <?php if($this->session->flashdata('flash_data')) :?>
          <div class="card-body">    
            <div class="alert alert-success alert-dismissible fade show" role="alert">
              Data Fasteljab <strong>berhasil</strong> <?= $this->session->flashdata('flash_data'); ?>.
                ...
                foreach ($witel as $b) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <?php if($this->session->userdata('role')==='1' || $this->session->userdata('role')==='16') { ?>
                        <td>
                          <a href="<?= base_url(); ?>cc_witel/verify_pekalongan/<?= $b['id']; ?>" class="btn-primary btn-sm">Verify</a>
                        </td>
                      <?php }?>
                    </tr>
                  <?php endforeach; ?>
