...
<div class="container-fluid">
  ...
  <p class="mb-4">Data mahasiswa/siswa batal/ditolak magang.</a></p>

  <!-- DataTales Example -->
  <div class="card shadow mb-4">
    <div class="card-header py-3">
      <div class="d-sm-flex align-items-center justify-content-between">
        <h6 class="m-0 font-weight-bold text-primary">Batal / Tolak</h6>
        <a href="<?= base_url('Export/exportBatal'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Excel</a>
      </div>
    </div>
            ...
            foreach ($batal as $a) : ?>
              <tr>
                ...
                <th>               
                   ...
                   <a href="<?= base_url(); ?>magang/detailBatal/<?= $a['id']; ?>" class="btn btn-primary btn-sm">Detail</a>
