      ...
      <div class="card card-danger">
        <div class="card-header py-3">
          <div class="d-sm-flex align-items-center justify-content-between">
            <h6 class="card-title">Edit Data Karyawan Semua Karyawan</div>
            </div>
                    ...
                    <div class="row">
                      <div class="col-6">
                          ...
                          <select class="custom-select" name="lok_kerja">
                              <option disabled>-- Pilih Lokasi Kerja --</option>
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <!-- <input type="hidden" name="status" value="Perlu Disesuaikan"> -->
