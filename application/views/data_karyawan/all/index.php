      ...
      <div class="card card-danger">
        <div class="card-header py-3">
          <div class="d-sm-flex align-items-center justify-content-between">
            <h6 class="card-title">Data Karyawan Semua Witel &nbsp;
              <!-- <?php if($this->session->userdata('role')==='1' || $this->session->userdata('role')==='2') { ?>
                <a href="<?= base_url('data_karyawan/add_div'); ?>" class="btn btn-warning btn-sm">Tambah Data</a>
              <?php }?> -->
            </h6>
            <a href="<?= base_url('Export/exportAllKaryawan'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Excel</a>
          </div>
        </div>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <td>
                        ...
                        <td>
                          <a href="<?= base_url(); ?>data_karyawan/edit_all/<?= $b['id']; ?>" class="btn-primary btn-xs">Edit</a>
                          <?php if($this->session->userdata('role')==='1') { ?>
                          <a href="<?= base_url(); ?>data_karyawan/hapus_all/<?= $b['id']; ?>" class="btn btn-danger btn-xs" onclick="return confirm('yakin?');">Hapus</a>
                          <?php }?>
                        </td>
