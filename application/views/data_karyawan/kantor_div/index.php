      ...
      <div class="row mb-2">
        ...
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            ...
            <li class="breadcrumb-item active">Kantor TREG IV</li>
          </ol>
        </div><!-- /.col -->
      </div><!-- /.row -->
    </div><!-- /.container-fluid -->
      ...
      <div class="card card-danger">
        <div class="card-header py-3">
          <div class="d-sm-flex align-items-center justify-content-between">
            <h6 class="card-title">Data Karyawan Kantor DIV IV &nbsp;
              <?php if($this->session->userdata('role')==='1' || $this->session->userdata('role')==='2') { ?>
                <a href="<?= base_url('data_karyawan/add_div'); ?>" class="btn btn-warning btn-sm">Tambah Data</a>
            </h6>
            <a href="<?= base_url('Export/exportHrKantorDiv'); ?>" class="d-none d-sm-inline-block btn btn-sm btn-warning shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Excel</a>
              <?php }?>
          </div>
        </div>
        ...
        <div class="card-body">
          <div class="table-responsive">
            <table style="text-align: center; width: auto;" id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>Nik</th>
                  <th>Nama</th>
                ...
                foreach ($kantor as $b) : ?>
                  <tr>
                    ...
                    <td>
                      ...
                      <?php if($this->session->userdata('role')==='1' || $this->session->userdata('role')==='2') { ?>
                        <td>
                          <a href="<?= base_url(); ?>data_karyawan/edit_div/<?= $b['id']; ?>" class="btn-primary btn-xs">Edit</a>
                          <?php if($this->session->userdata('role')==='1') { ?>
                          <a href="<?= base_url(); ?>data_karyawan/hapus_div/<?= $b['id']; ?>" class="btn btn-danger btn-xs" onclick="return confirm('yakin?');">Hapus</a>
                          <?php }?>
                        </td>
                      <?php }?>
                    </tr>
