      ...
      <div class="card card-danger">
        <div class="card-header py-3">
          <div class="d-sm-flex align-items-center justify-content-between">
            <h6 class="card-title">Tambah Data Karyawan Witel Kudus</div>
            </div>

            <!-- form start -->
            <form role="form" method="post" action="<?= base_url('data_karyawan/add_kudus'); ?>">
              <div class="card-body">
                  ...
                  <div class="form-group">
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <input type="hidden" name="lok_kerja" class="form-control" value="Witel Kudus">
